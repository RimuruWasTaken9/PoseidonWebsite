...
document.addEventListener("DOMContentLoaded", function () {
  ...
  //removes the underline from all nav items
  ...
  switch (window.location.pathname) {
    ...
    case "/index.html":
      ...
      // Handle the carousel thumbnails click
      var thumbnailSelectors = document.querySelectorAll(
      ...
      thumbnailSelectors.forEach(function (selector) {
        selector.addEventListener("click", function () {
          ...
          var id = id_selector.substr(id_selector.length - 1);
          id = parseInt(id);
          var carousel = bootstrap.Carousel.getInstance(
      ...
      myCarousel.addEventListener("slid.bs.carousel", function () {
        ...
        document
          .getElementById("carousel-selector-" + id)
        ...
        (entries, observer) => {
          ...
          entries.forEach((entry) => {
            ...
            if (topMostEntry) {
              ...
              document
                .querySelector("#nav-" + targetElement.id + " a")
                .classList.add("selected");
            }
          });
        },
